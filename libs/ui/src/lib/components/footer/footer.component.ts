  ...
  template: `
    <footer class="bg-obsidian-950 border-t border-white/5 py-16 px-6">
      <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        <div>
          <p class="font-display text-2xl mb-4">Savage Media</p>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><a href="mailto:hello&#64;savagemedia.online" class="font-body text-sm text-white/50 hover:text-gold-400 transition-colors">hello&#64;savagemedia.online</a></li>
          </ul>
        </div>
      </div>
      <div class="max-w-6xl mx-auto mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between gap-4">
        <p class="font-body text-white/20 text-xs">© {{ year }} Savage Media. All rights reserved.</p>
